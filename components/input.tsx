...
export interface InputProps
  ...
  helperText?: string;
  errorText?: string;
  /** Overrides state to "success" and shows a check-style border/ring */
  success?: boolean;
  leadingIcon?: React.ReactNode;
  trailingIcon?: React.ReactNode;
  /** Show an (X) button to clear the field. Ignored for type="password" unless explicitly combined. */
  clearable?: boolean;
  /** Adds a show/hide toggle. Only meaningful when type="password" */
...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const resolvedState = errorText ? "error" : success ? "success" : state ?? "default";
    ...
    const hasTrailingControls = showClearButton || showPasswordToggle || trailingIcon;
